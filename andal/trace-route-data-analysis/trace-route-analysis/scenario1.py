...
for filename in os.listdir(dir):
    ...
    flag = 0;
    dest_dir = '/Users/andalpriyadarshinijayaseelan/PycharmProjects/ispViz/trace-route-analysis/generated/RouteDataLocationExtraction/';
    dest = '/Users/andalpriyadarshinijayaseelan/PycharmProjects/ispViz/trace-route-analysis/generated/RouteDataLocationExtraction/' + "routesData" + extract_suffix;
    for route_file in os.listdir(dest_dir):
        route_file = dest_dir + route_file;
        if(route_file == dest):
            os.rename(path, "./generated/traceRouteProcessed/" + filename);
            print('breaking');
            flag = 1;
            break;
    ...
    if(flag == 0):
        try:
            ...
            os.rename(path, "./generated/traceRouteData-Discrepancy/" + filename);
            continue;
